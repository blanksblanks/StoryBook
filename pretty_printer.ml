...
let rec print_expr = function
	...
	| Lit_int(i) -> Printf.printf "%d " i 
	| Lit_string(str) -> Printf.printf "%s " str
	| Lit_bool(b) -> Printf.printf "%B " b
	| Lit_char(c) -> Printf.printf "%c" c
	...
	| FCall(str, expr_list) -> Printf.printf "%s(" str; let rec print_expr_list_comma = function
	[] -> print_string ""
	| hd::[] -> print_expr hd
	| hd::tl -> print_expr hd; print_string ", "; print_expr_list_comma tl 
	in print_expr_list_comma expr_list; print_string ") "
    | ACall(str, str, expr_list) -> Printf.printf "%s %s(" str; str; let rec print_expr_list_comma = function
	[] -> print_string ""
	| hd::[] -> print_expr hd
	| hd::tl -> print_expr hd; print_string ", "; print_expr_list_comma tl 
	in print_expr_list_comma expr_list; print_string ") "
